print "-"*20 + "Class and instance attributes" + "-"*20
...
print "-"*20 + "Class and instance methods" + "-"*20
...
print Third.__getattribute__(a, "Kozel") #<bound method Third.Kozel of <__main__.Third object at 0xb72dad4c>> - __getattribut__ on class
print a.__getattribute__("Kozel") #<bound method Third.Kozel of <__main__.Third object at 0xb7315d2c>> - __getattribut__ on instance
...
print repr(f.__dict__) #{'bamf': 10}
f.x = "Oslik" #setx
print repr(f.__dict__) #{'_Third1__x': 'Oslik', 'bamf': 10}
print f.x 
#getting `x`   
#getx    
#getting `_Third1__x`
